    ...
    <body>
        <div class="side_content">
            ...
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px;">
                ...
                <li>
                    <a href="/video" class="nav-link link-body-emphasis">
                    <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#table"/></svg>
                    投稿一覧
                    </a>
                </li>
                <li>
                    <a href="/video/create" class="nav-link link-body-emphasis">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li>
                        <a class="dropdown-item" href="/logout">
                            　
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-closed me-2" viewBox="0 0 16 16">
